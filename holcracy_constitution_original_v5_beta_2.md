...
## 1.2 ロールのアサイン
ロールはそのロールのドメインを通じて、だれにどのロールを割り当てるかをコントロールできます。そのようなドメインを持っている人は誰でも、割り当てられる側が受け入れさえすればコントロールが可能です。また、同時に複数人を割り当てるすることもできます。そのように割り当てられた人はだれでも、「ロールリード」としての役割を果たします。ロールリードは、別段の合意がなければいつでも任務を辞任することができます。ロールの割り当てをコントロールする人はいつでもロールリードの割り当てを解除することができます。ポリシーによってロールの割り当てや解除が制限される場合があります。また、ロールに複数の人をアサインする場合は、Authorityとなる人を一人定めなければなりません。ロールの最終的な意思決定および判断は、Authorityのそれに従うものとします。 
...
*組織*の他の*ロールリード*が自分の就いている*ロール*を代表して行動しているとき、あなたは*ロールリード*として彼らに対して次の義務を負います（※ロール名を名乗る件は消えた）。
...
- **(c) ドメインに影響を与える要求:** 他の人は、あなたの*ロール*のいずれかがコントロールしている*領域*に影響を与える許可を求めることができます。あなたは、あなたのロールの目的または責務を遂行する能力が低下する理由（※*反論*がこれに言い換えられた）が見つからない場合は、その影響を許可しなければなりません。もしそのような理由がある場合は、あなたはそれを要求者に説明しなければなりません。
...
- **(c) サークルの優先順位:**（※新しい項目） あなたが何に取り組むかを選択するときは、あなたのロールが属するサークルもしくはそのいずれかのスーパーサークルの公式の*戦略*もしくは相対的な優先順位を考慮しなければなりません。公式の優先順位とは、*サークルリード*、もしくは、優先順位の衝突を解決し*サークル*の*戦略*を定義する権限をもつ*ロール*またはプロセスによって定義されたものです。その上であなたは、あなたの個人的な優先順位やあなたが感じる*組織*の優先順位よりも、*組織*にとってこれらの公式の優先順位の方がより重要なものとして扱う必要があります。
...
# 第6章 人とパートナーシップ
## 6.1 パートナー関係
*組織*は、この*憲法*を順守することに同意したすべての人に*パートナー*の地位を付与することができます。これにより、その人と*組織*の間に ***パートナー関係(Partner Relationship)*** が成立します。*パートナー*の地位の付与に際して、一方の当事者が他方に対して行う約束は、その*パートナー関係*の一部です。別段の合意がない限り、各当事者は、これらの協定を変更するために相手の同意を必要とします。ただし、パートナーは、他方の同意なしに*パートナー関係*を終了することができます。そうすることで、*パートナー*としてのその人の権利と責任は直ちに終了します。
