...
### ガバナンスミーティングの出席者
ガバナンスミーティングに出席するのは、SecretaryとFacilitatorを含むコアサークルメンバー全員である。それに加え、Rep Linik, Cross Link, Lead Linkはそれぞれ最大1人づつ他のメンバーを呼ぶことができる。呼ばれた人は会議中はコアサークルメンバーとなる。ガバナンスミーティングには、上記に指定されたメンバー以外の参加は許されていない。
